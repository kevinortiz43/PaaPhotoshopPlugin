...
//
static grad_aff::TypeClass PickPaaTypeClass(bool hasAlpha, bool isGrayscale) {
    if (isGrayscale)  return grad_aff::TypeClass::AI88;
    if (hasAlpha)     return grad_aff::TypeClass::DXT5;
    return grad_aff::TypeClass::DXT1;
}
...
static void DoReadStart() {
    ...
    switch (paa.typeClass) {
    case grad_aff::TypeClass::AI88:
        isGrayscale = true;
        hasAlpha    = true;  // AI88 has 8-bit greyscale + 8-bit alpha
        break;
    case grad_aff::TypeClass::DXT5:
    case grad_aff::TypeClass::DXT3:
    case grad_aff::TypeClass::ARGB4444:
    case grad_aff::TypeClass::ARGB1555:
    case grad_aff::TypeClass::ARGB8888:
        hasAlpha = true;
        break;
    case grad_aff::TypeClass::DXT1:
    default:
...
static void DoWriteStart() {
    ...
    // ---------------------------------------------------------------
    auto paa = grad_aff::Paa();
    paa.typeClass    = PickPaaTypeClass(hasAlpha, isGrayscale);
